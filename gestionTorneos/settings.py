"""
Django settings for gestionTorneos project.
...
SECRET_KEY = 'django-insecure-i)l0f9&0+@7b(x^66@6nvlrmcyd#f=f!&^crok(pk3%olltij3'
...
ROOT_URLCONF = 'gestionTorneos.urls'
...
WSGI_APPLICATION = 'gestionTorneos.wsgi.application'
